...
function hideProxyUrlModal() {
    const proxyUrlModal = document.getElementById('proxyUrlModal');
    if (proxyUrlModal) {
        proxyUrlModal.style.display = 'none';
    }
}

function showProxyUrlError() {
    const errorElement = document.getElementById('proxyUrlError');
    if (errorElement) {
